...
#c.SlidesExporter.font_awesome_url = 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.1.0/css/font-awesome.css'
c.SlidesExporter.font_awesome_url = './static/css/font-awesome.css'

## URL to load jQuery from.
#
#  Defaults to loading from cdnjs.
#c.SlidesExporter.jquery_url = 'https://cdnjs.cloudflare.com/ajax/libs/jquery/2.0.3/jquery.min.js'
c.SlidesExporter.jquery_url = './static/js/jquery.min.js'
...
c.SlidesExporter.require_js_url = './static/js/require.min.js'
...
#  modify the patterns traitlet. For example, execute the following command to
#  convert a notebook to html and remove cells containing only whitespace:
#
#  > jupyter nbconvert --RegexRemovePreprocessor.enabled=True
#  --RegexRemovePreprocessor.patterns="['\s*\Z']" mynotebook.ipynb
#
#  The first command line argument enables the preprocessor and the second sets
#  the list of patterns to '\s*\Z' which matches an arbitrary number of
#  whitespace characters followed by the end of the string.
#
...
##
#c.RegexRemovePreprocessor.patterns = ['\\Z']
